            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    ...
                    <select id="forma_pago" name="forma_pago" class="form-control" required>
                        ...
                        <option value="001">Targeta de credito</option>
                        <option value="001">targeta debito</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="row">
                <div class="col-12 col-sm-4">
                    ...
                    <input class="form-control" id="codigo" name="codigo" type="text" placeholder="Escribir el codigo y enter" onkeyup="agregarProducto(event, this.value, 1, <?php echo $idVentaTmp; ?>);" autofocus />
