        ...
        <div class="form-group">
            <div class="row">
                <div class="col-12 col-sm-4">
                    ...
                    <input class="form-control" id="codigo" name="codigo" type="text" placeholder="Escribir el codigo y enter" onkeyup="buscarProducto(event, this, this.value)" autofocus />
